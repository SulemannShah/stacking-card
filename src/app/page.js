...
const Approach = () => {
  ...
  useEffect(() => {
    ...
    const runGSAP = async () => {
      ...
      ctx = gsap.context(() => {
        if (!cardsWrapperRef.current || !cardsInnerRef.current) return;
        ...
        // Calculate how much to translate inner so its bottom reaches viewport bottom
        const wrapperHeight = wrapper.offsetHeight;
        const innerHeight = inner.offsetHeight;
        const maxTranslate = innerHeight - wrapperHeight;
  ...
  return (
    <>
      <section className="approch">
        <div className="approch__inner">
          <div className="approch__tile-wrapper">
            <h2 className="approch__title">
              My Approach:
              <br /> Real Solutions That Scale and Last
            </h2>
          </div>
        ...
        {/* Spacer to allow scroll after pinning */}
        <div style={{ height: "100vh" }}></div>
      </section>
      <section className="dummy3"></section>
      <section className="dummy3"></section>
    </>
  );
};
